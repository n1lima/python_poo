...
if __name__ == "__main__":
    ...
    candidatos = {} #chave vai ser o numero
    try:
        ...
        print('carregando arquivos de canditadotas')
    ...
    open_usr = 1
    while open_usr in (1,2):
        open_usr = int(input("Gerenciar 1- Candidato, 2- Eleitores [1,2]: "))
